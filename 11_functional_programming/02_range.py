...
that provides “the opportunity to go over the specific series of numbers” without actually creating the list of numbers. 
Getting an object instead of the whole list has a number of advantages.
One is space. In the next example we’ll see how much memory is needed for the object returned by the range function and
how much would it take to have the corresponding list of numbers in memory. For now let’s seehow can we use it:
