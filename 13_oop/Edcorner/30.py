...
Next, implement a method get_first_name( ) which reads the value of the firstname protected attribute. 
Then, using the get_first_name( ) method and the property class, create a property named
firstname (read-only property).
